  ...
  return (
    <AnimatePresence>
      {visible && (
        ...
        >
          {/* ── Orbiting graphics container (scaled for mobile/tablet screen compatibility) ── */}
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none scale-[0.52] xxs:scale-[0.58] xs:scale-[0.7] sm:scale-[0.85] md:scale-100 origin-center transition-all duration-500">
            {/* ── Orbit ring visuals ────────────────────── */}
            <motion.div
